...
func (b *BTCC) Run() {
	...
	if common.StringDataContains(b.CurrencyPairs.Pairs[assets.AssetTypeSpot].Enabled.Strings(), "CNY") ||
		common.StringDataContains(b.CurrencyPairs.Pairs[assets.AssetTypeSpot].Available.Strings(), "CNY") ||
