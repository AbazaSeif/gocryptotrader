...
func (h *HitBTC) Run() {
	...
	forceUpdate := false
	if !common.StringDataContains(h.CurrencyPairs.Pairs[assets.AssetTypeSpot].Enabled.Strings(), "-") ||
		!common.StringDataContains(h.CurrencyPairs.Pairs[assets.AssetTypeSpot].Available.Strings(), "-") {
