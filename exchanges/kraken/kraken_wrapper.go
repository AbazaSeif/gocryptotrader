...
func (k *Kraken) Run() {
	...
	forceUpdate := false
	if !common.StringDataContains(k.CurrencyPairs.Pairs[assets.AssetTypeSpot].Enabled.Strings(), "-") ||
		!common.StringDataContains(k.CurrencyPairs.Pairs[assets.AssetTypeSpot].Available.Strings(), "-") {
