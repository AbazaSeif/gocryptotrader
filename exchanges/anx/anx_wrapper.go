...
func (a *ANX) Run() {
	...
	forceUpdate := false
	if !common.StringDataContains(a.CurrencyPairs.Pairs[assets.AssetTypeSpot].Enabled.Strings(), "_") ||
		!common.StringDataContains(a.CurrencyPairs.Pairs[assets.AssetTypeSpot].Available.Strings(), "_") {
