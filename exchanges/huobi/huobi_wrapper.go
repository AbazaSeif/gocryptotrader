...
func (h *HUOBI) Run() {
	...
	if common.StringDataContains(h.CurrencyPairs.Pairs[assets.AssetTypeSpot].Enabled.Strings(), "CNY") ||
		common.StringDataContains(h.CurrencyPairs.Pairs[assets.AssetTypeSpot].Available.Strings(), "CNY") {
		forceUpdate = true
	}
