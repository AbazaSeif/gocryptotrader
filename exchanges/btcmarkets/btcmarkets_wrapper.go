...
func (b *BTCMarkets) Run() {
	...
	forceUpdate := false
	if !common.StringDataContains(b.CurrencyPairs.Pairs[assets.AssetTypeSpot].Enabled.Strings(), "-") ||
		!common.StringDataContains(b.CurrencyPairs.Pairs[assets.AssetTypeSpot].Available.Strings(), "-") {
